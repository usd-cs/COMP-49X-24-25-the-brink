  ...
  try {
    const query = `
      INSERT INTO ace_applications (
        corporate_name, address, dba, duns, naics, hub_zone, rural, women_owned, disaster_impacted,
        ...
        agency, award_amount, contract_number, grant_start_end, company_info, customer_discovery,
        go_to_market_strategy, intellectual_property, financing, success_record
      ) VALUES (
        $1, $2, $3, $4, $5, $6, $7, $8, $9,
    ...
    const values = [
      ...
      companyInfo, customerDiscovery, goToMarketStrategy, intellectualProperty, financing, successRecord
    ]
...
app.get('/api/get-profile', async (req, res) => {
  ...
  try {
    const result = await pool.query('SELECT first_name, last_name, email, phone FROM users WHERE email = $1', [email])
